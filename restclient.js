...
//      (c) 2012 Enrique Ponce de Leon, Qennix.com
...
(function () {
    ...
    // Keep a reference of the window or global object
    var root = this;
    ...
    // Check if library 'undescore' is loaded
    var _ = root._;
    if (!_ && (require !== 'undefined')) {
    ...
    RestClient.setGrantType = function (type, data) {
        this.authorization.grant_type = (OAUTH2GrantTypes[type] !== 'undefined') ? OAUTH2GrantTypes[type]
                : null;
    ...
    **/
    ...
    RestClient.consume = function (method, options, callback, authorize) {
        ...
        if (needsAuthorization) {
           var basicHash = Base64.encode(this.authorization.client_id + ':' + this.authorization.client_secrect);
